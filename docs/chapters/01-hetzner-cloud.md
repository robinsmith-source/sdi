...
> This chapter explains how to set up a Hetzner Cloud account and access your first server.
...
2. Complete the account verification process (ID verification and payment method may be required).
...
6. Configure the firewall with the following settings:
   ...
   - **Rules**: Add an inbound rule to allow SSH access.

   | IP Version          | Protocol | Port |
   | ------------------- | -------- | ---- |
   | Any IPv4 / Any IPv6 | TCP      | 22   |

## 3. Creating Your First Server [Exercise 1] {#exercise-1}
...
### 3.2 Testing Server Connectivity
...
### 3.4 Understanding the SSH Connection Message
...
### 3.5 Accessing Your Server via Web GUI
...
## 5. Server Re-creation and SSH Host Key Management [Exercise 2] {#exercise-2}
...
### 5.3 The SSH Host Key Change Warning
